...
export type EDynamicBoxType = "Horizontal" | "Vertical" | "Wrap" | "VerticalWrap" | "Radial" | "Overlay" | "EDynamicBoxType_MAX";
export const EDynamicBoxType: {Horizontal: "Horizontal" ,Vertical: "Vertical" ,Wrap: "Wrap" ,VerticalWrap: "VerticalWrap" ,Radial: "Radial" ,Overlay: "Overlay" ,EDynamicBoxType_MAX: "EDynamicBoxType_MAX"};
export interface RadialBoxSettings {
...
export type EVirtualKeyboardTrigger = "OnFocusByPointer" | "OnAllFocusEvents" | "EVirtualKeyboardTrigger_MAX";
export const EVirtualKeyboardTrigger: {OnFocusByPointer: "OnFocusByPointer" ,OnAllFocusEvents: "OnAllFocusEvents" ,EVirtualKeyboardTrigger_MAX: "EVirtualKeyboardTrigger_MAX"};
...
export type ETextTransformPolicy = "None" | "ToLower" | "ToUpper" | "ETextTransformPolicy_MAX";
export const ETextTransformPolicy: {None: "None" ,ToLower: "ToLower" ,ToUpper: "ToUpper" ,ETextTransformPolicy_MAX: "ETextTransformPolicy_MAX"};
...
export type EScrollWhenFocusChanges = "NoScroll" | "InstantScroll" | "AnimatedScroll" | "EScrollWhenFocusChanges_MAX";
export const EScrollWhenFocusChanges: {NoScroll: "NoScroll" ,InstantScroll: "InstantScroll" ,AnimatedScroll: "AnimatedScroll" ,EScrollWhenFocusChanges_MAX: "EScrollWhenFocusChanges_MAX"};
...
export interface SoundEffectPresetUserWidgetProps extends UserWidgetProps {
}

export class SoundEffectPresetUserWidget extends React.Component<SoundEffectPresetUserWidgetProps> {}
...
export interface ReactTestWidgetProps extends EditorUtilityWidgetProps {
    Script?: string;
    ReactWidgetUpdateDelegate?: () => void;
}

export class ReactTestWidget extends React.Component<ReactTestWidgetProps> {}
...
export interface Synth2DSliderStyle extends SlateWidgetStyle {
    NormalThumbImage?: SlateBrush;
    DisabledThumbImage?: SlateBrush;
    NormalBarImage?: SlateBrush;
    DisabledBarImage?: SlateBrush;
...
export interface Synth2DSliderProps extends WidgetProps {
    ValueX?: number;
    ValueY?: number;
...
export class Synth2DSlider extends React.Component<Synth2DSliderProps> {}

export type ESynthKnobSize = "Medium" | "Large" | "Count" | "ESynthKnobSize_MAX";
export const ESynthKnobSize: {Medium: "Medium" ,Large: "Large" ,Count: "Count" ,ESynthKnobSize_MAX: "ESynthKnobSize_MAX"};
export interface SynthKnobStyle extends SlateWidgetStyle {
...
export interface SynthKnobProps extends WidgetProps {
    Value?: number;
    StepSize?: number;
    MouseSpeed?: number;
...
export class SynthKnob extends React.Component<SynthKnobProps> {}

export interface Test_CProps extends ReactTestWidgetProps {
}

export class Test_C extends React.Component<Test_CProps> {}

export interface PointerToUberGraphFrame {
}

export interface SKEL_Test_CProps extends ReactTestWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
}

export class SKEL_Test_C extends React.Component<SKEL_Test_CProps> {}

export interface SKEL_NewEditorUtilityWidgetBlueprint_CProps extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class SKEL_NewEditorUtilityWidgetBlueprint_C extends React.Component<SKEL_NewEditorUtilityWidgetBlueprint_CProps> {}

export interface NewEditorUtilityWidgetBlueprint_CProps extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class NewEditorUtilityWidgetBlueprint_C extends React.Component<NewEditorUtilityWidgetBlueprint_CProps> {}

export interface ttttttt_CProps extends UserWidgetProps {
}

export class ttttttt_C extends React.Component<ttttttt_CProps> {}

export interface SKEL_ttttttt_CProps extends UserWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
}

export class SKEL_ttttttt_C extends React.Component<SKEL_ttttttt_CProps> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_8Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_8 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_8Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_13Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_13 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_13Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_15Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_15 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_15Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_17Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_17 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_17Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_20Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_20 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_20Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_29Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_29 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_29Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_31Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_31 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_31Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_33Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_33 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_33Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_41Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_41 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_41Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_45Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_45 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_45Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_62Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_62 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_62Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_65Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_65 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_65Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_68Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_68 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_68Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_70Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_70 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_70Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_95Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_95 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_95Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_98Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_98 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_98Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_100Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_100 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_100Props> {}

export interface REINST_NewEditorUtilityWidgetBlueprint_C_104Props extends EditorUtilityWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    NewEventDispatcher_0?: () => void;
}

export class REINST_NewEditorUtilityWidgetBlueprint_C_104 extends React.Component<REINST_NewEditorUtilityWidgetBlueprint_C_104Props> {}
